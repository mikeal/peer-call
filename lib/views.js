...
<div class="card" id="a${item => item.key}">
  ...
  <div class="extra content">
    ...
    <div class="volume">
      <div class="checkbox audio-in">
        <input type="checkbox" name="mute" id='mute-audio-in-${item => item.key}' class='mute-checkbox'>
        <label for='mute-audio-in-${item => item.key}'><i class='unmute icon grow'></i></label>
      </div>
      <div class="checkbox audio-out ${item => item.key === 'me' ? '' : 'hide'}">
        <input type="checkbox" name="mute-audio-out-${item => item.key}" id="mute-audio-out-${item => item.key}" class='mute-checkbox'>
        <label for='mute-audio-out-${item => item.key}'><i class='volume up icon grow'></i></label>
      </div>
