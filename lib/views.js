...
<div class="join-container">
  <div class="ui large buttons buttons-wide">
    <button onclick=${() => { navigate('room') }} id="join-party" class="ui button"><i class="fa fa-users fa-2x" aria-hidden="true"></i> Join the Party</button>
      <div class="or"></div>
    <button onclick=${() => { navigate(random()) }} id="create-room" class="ui button"><i class="fa fa-volume-up fa-2x" aria-hidden="true"></i> Create New Room</button>
  </div>
</div>
`
